			...
			foreach ($bacs_accounts as $i=> $bacs_account) {
				...
				if ($has_details) {
					...
					$showPayment .= '
						...
						<button  name="submit_paid" id="input_mpay" class="submit_paid_'.$i.'" style="margin-bottom: 20px;" '.($disabled? '': 'onclick="fetchStatus('.$i.')"').' type="button"
